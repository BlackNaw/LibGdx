...
public class CollisionUno extends ApplicationAdapter {
	...
	public void create() {
		...
		// Creamos el punto
		punto = new Texture(Gdx.files.internal("tie.png"));
		...
		bodyEdgeScreen.setUserData("TitoJose");
		edgeShape.dispose();
		...
		world.setContactListener(new ContactAdapter() {
			...
			public void beginContact(Contact contact) {
				...
				// caja=body;
				// if(caja!=null)
				// //Si lo quiero aplicar sobre lsa posiciones mundiales del
				// cuerpo
				// caja.applyLinearImpulse(0, 15, caja.getWorldCenter().x,
				// caja.getWorldCenter().y, true);
